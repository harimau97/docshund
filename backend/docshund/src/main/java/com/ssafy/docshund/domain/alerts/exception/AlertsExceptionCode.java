...
public enum AlertsExceptionCode implements ExceptionCode {
	...
	ALERT_NOT_FOUND(NOT_FOUND, "AL-C-005", "해당 알림을 찾을 수 없습니다."),
	REQUIRED_IS_EMPTY(BAD_REQUEST, "AL-C-006", "필수 요소는 비워둘 수 없습니다."),
	TOO_MANY_REQUEST(BAD_REQUEST, "AL-C-007", "요청이 너무 많습니다."),

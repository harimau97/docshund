...
public class DocsServiceImpl implements DocsService {
    ...
    public DocumentDto getDocumentDetail(Integer docsId) {
        ...
        // 증가된 viewCount 반영하여 DocumentDto 리턴
    ...
    public List<OriginDocumentDto> createOriginDocuments(Integer docsId, String content) {
        ...
        try {
            ...
            System.out.println("[Service] Parsed JSON: " + (resultJson.length() > 100 ? resultJson.substring(0, 100) : resultJson));
            return objectMapper.readValue(resultJson, new TypeReference<List<OriginDocumentDto>>() {});

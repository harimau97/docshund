              ...
              <form onSubmit={handleSubmit}>
                <div className="mb-6">
                  ...
                  >
                    ...
                    <option value="DOCUMENT_REQUEST">신고 카테고리</option>
                    <option value="ABUSIVE_LANGUAGE_OR_VIOLENCE">
                      욕설 및 폭력성
                    </option>
                    <option value="EXPLICIT_OR_ILLEGAL_CONTENT">
                      음란물 및 불법 콘텐츠
                    </option>
                    <option value="PROMOTING_GAMBLING">사행성 조장</option>
                    <option value="SPAM_OR_ADVERTISING">스팸 및 광고</option>
                    <option value="FLOODING">도배</option>
